...
void Probability_Vacuum_LBL(double s12sq, double s13sq, double s23sq, double delta, double Dmsq21, double Dmsq31, double L, vector<double> E, vector<array<array<double, 3>, 3>> *probs_returned)
{
